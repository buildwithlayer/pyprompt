...
def test_tool_call_get_token_map():
    ...
    assert tool_call.get_token_map(dict(), encode) == {
        0: [
            5018, 307, 794, 330, 15031, 13193, 498, 330, 1337, 794, 330, 1723, 498, 330, 1723, 794, 5324, 609, 794, 330,
            49885, 57850, 5263, 498, 330, 16774, 794, 36603, 32075,
        ],
    }
...
def test_assistant_message_generate_messages():
    ...
    message = AssistantMessage(ToolCall("some-id", "function", "ReallyCoolFunction", "{}"))
    render_map = {
        0: {
